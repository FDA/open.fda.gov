...
const URL = '/apis/device/registrationlisting/';

context('Device Registration and Listing dataset pages', () => {
    var helper;

    beforeEach(() => {
        loadAndAcceptDisclaimer(URL);
        helper = new EndpointPagesTestHelper(URL, '/device/registrationlisting.json');
    })
