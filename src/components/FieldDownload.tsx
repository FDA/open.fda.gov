...
const pdfDownloadMap: Readonly<Record<string, string>> = Object.freeze({
  ...
  'drugresearchcbdliverjama': '/fields/drugresearchcbdliverjama_reference.pdf',
...
const xlsxDownloadMap: Readonly<Record<string, string>> = Object.freeze({
  ...
  'drugresearchcbdliverjama': '/fields/drugresearchcbdliverjama_reference.xlsx',
...
const yamlDownloadMap: Readonly<Record<string, string>> = Object.freeze({
  ...
  'drugresearchcbdliverjama': '/fields/drugresearchcbdliverjama.yaml',
