...
const _scrollIntoView = (e: any) => {
  ...
  const el: Object | null | undefined = document.getElementById(id)
  scrollIntoView(el, {
    align: {
      top: 0.16,
      left: 0
    },
    ease: function (value: number) {
      return 1 - Math.pow(1 - value, value / 5)
    }
  })
}

const _scrollToTop = (e: any) => {
...
const ReferenceMenu = (props: ReferenceMenuProps) => {
  const {
    content,
    isBottom,
    isFixed,
  ...
  return (
    <menu
      ...
      style={{
        ...
        paddingTop: !isFixed && !isBottom ? '40px' : undefined
      }}>
      {
