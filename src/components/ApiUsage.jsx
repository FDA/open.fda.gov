            ...
            <div>
              <table className="table-sm table-bordered">
                <tbody>
                  ...
                  <tr><td>Adverse Event Reports</td><td id='foodevent'>{this.docCount('foodevent')}</td></tr>
                  <tr><td>Enforcement Reports</td><td id='foodenforcement'>{this.docCount('foodenforcement')}</td></tr>

                  <tr className="bg-primary-darkest clr-white"><td colSpan="2"><strong>Devices</strong></td></tr>
                  <tr><td>Classifications</td><td id='deviceclass'>{this.docCount('deviceclass')}</td></tr>
                  <tr><td>Registration and listing</td><td id='devicereglist'>{this.docCount('devicereglist')}</td></tr>
                  <tr><td>Premarket Approvals (PMAs)</td><td id='devicepma'>{this.docCount('devicepma')}</td></tr>
                  <tr><td>510Ks</td><td id='deviceclearance'>{this.docCount('deviceclearance')}</td></tr>
                  <tr><td>Recalls</td><td id='devicerecall'>{this.docCount('devicerecall')}</td></tr>
                  <tr><td>Adverse Event Reports</td><td id='deviceevent'>{this.docCount('deviceevent')}</td></tr>
