...
const ApiStatus = (props: tPROPS) => (
  <section>
    ...
    <div className=' clr-white bg-secondary-darkest'>
      <div className='container warning-box pad-b-1 pad-t-1'>Currently, there is a temporary suspension of updates to
        the openFDA datasets. Please send inquiries regarding this matter to: <a className='clr-white underline' href="mailto:open@fda.hhs.gov">open@fda.hhs.gov</a>
      </div>
    </div>
