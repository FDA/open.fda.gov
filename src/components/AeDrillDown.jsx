...
class AeDrillDown extends Component {
	...
	getData() {
		let selectedEvent = this.state.selectedEvent['value']
		let url = 'https://openfda-api.preprod.fda.gov/other/historicaldocumentanalytics.json?search=adverse_events_mentioned.meddra_term:'
