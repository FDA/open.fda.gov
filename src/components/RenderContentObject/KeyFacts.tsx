...
class KeyFacts extends React.Component<KeyFactsProps> {
  constructor (props: KeyFactsProps) {
    super(props)
    this.state = {
      lastUpdated: null
    }
      ...
      <section className='key-facts'>
        ...
        <ul>
          <li>
            ...
            <div className='value'>
              {
                sourceLink[this.props.noun_name as keyof typeof sourceLink]?.hasOwnProperty(this.props.endpoint_name) &&
