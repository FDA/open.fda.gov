...
export const pdfDownloadMap: Readonly<Record<string, string>> = Object.freeze({
  ...
  'drugorangebook': '/fields/drugshortages_reference.pdf',
  'drugresearchopioidandssri': '/fields/drugresearchopioidandssri_reference.pdf',
...
export const xlsxDownloadMap: Readonly<Record<string, string>> = Object.freeze({
  ...
  'drugresearchopioidandssri': '/fields/drugresearchopioidandssri_reference.xlsx',
...
export const yamlDownloadMap: Readonly<Record<string, string>> = Object.freeze({
  ...
  'drugresearchopioidandssri': '/fields/drugresearchopioidandssri.yaml',
