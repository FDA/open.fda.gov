...
export const xlsxDownloadMap: Readonly<Record<string, string>> = Object.freeze({
  ...
  'drugresearchcbdliverjamap1': '/fields/drugresearchcbdliverjamap1_reference.xlsx',
  'drugresearchcbdliverjamap2': '/fields/drugresearchcbdliverjamap2_reference.xlsx',
...
export const yamlDownloadMap: Readonly<Record<string, string>> = Object.freeze({
  ...
  'drugresearchcbdliverjamap1': '/fields/drugresearchcbdliverjamap1.yaml',
  'drugresearchcbdliverjamap2': '/fields/drugresearchcbdliverjamap2.yaml',
