    ...
    return (
      <section className="doc-content">
        ...
        <ol>
          ...
          <li>Review the <Link to="/docs/device/510k/searchable-fields">list of searchable fields</Link> available in the 510(k) dataset.</li>
          <li>Try out the 510(k) API using the <Link to="/docs/device/510k/explore-the-api-with-an-interactive-chart/">interactive examples</Link>.</li>
        </ol>
