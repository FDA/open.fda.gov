  ...
  render() {
    ...
    return (
      <section className="doc-content">
        ...
        <p>The <strong>openFDA Device 510(k) Clearances API</strong>strong> contains details about specific products and the original sponsors of premarket notification applications. It also contains administrative and tracking information about the applications and receipt and decision dates.</p>
