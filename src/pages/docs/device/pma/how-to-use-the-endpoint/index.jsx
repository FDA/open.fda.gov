    ...
    return (
      <section className="doc-content">
        ...
        <ol>
          ...
          <li>Review the <Link to="/docs/device/pma/searchable-fields">list of searchable fields</Link> available in the Device Pre-Market Approval dataset.</li>
          <li>Try out the Device Pre-Market Approval API using the <Link to="/docs/device/pma/explore-the-api-with-an-interactive-chart/">interactive examples</Link>.</li>
        </ol>
