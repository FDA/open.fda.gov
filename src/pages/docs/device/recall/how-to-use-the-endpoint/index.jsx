    ...
    return (
      <section className="doc-content">
        ...
        <ol>
          ...
          <li>Review the <Link to="/docs/device/recall/searchable-fields">list of searchable fields</Link> available in the Device Recall dataset.</li>
          <li>Try out the Device Recall API using the <Link to="/docs/device/recall/explore-the-api-with-an-interactive-chart/">interactive examples</Link>.</li>
        </ol>
