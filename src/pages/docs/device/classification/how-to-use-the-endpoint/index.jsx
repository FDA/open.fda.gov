    ...
    return (
      <section className="doc-content">
        ...
        <ol>
          ...
          <li>Review the <Link to="/docs/device/classification/searchable-fields">list of searchable fields</Link> available in the Device Classification dataset.</li>
          <li>Try out the Device Classification API using the <Link to="/docs/device/classification/explore-the-api-with-an-interactive-chart/">interactive examples</Link>.</li>
        </ol>
