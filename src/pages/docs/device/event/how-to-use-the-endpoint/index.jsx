    ...
    return (
      <section className="doc-content">
        ...
        <ol>
          ...
          <li>Review the <Link to="/docs/device/event/searchable-fields">list of searchable fields</Link> available in the Device Adverse Event dataset.</li>
          <li>Try out the Device Adverse Event API using the <Link to="/docs/device/event/explore-the-api-with-an-interactive-chart/">interactive examples</Link>.</li>
        </ol>
