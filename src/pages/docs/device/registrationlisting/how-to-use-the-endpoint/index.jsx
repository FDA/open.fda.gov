    ...
    return (
      <section className="doc-content">
        ...
        <ol>
          ...
          <li>Review the <Link to="/docs/device/registrionlisting/searchable-fields">list of searchable fields</Link> available in the Device Registrations & Listings dataset.</li>
          <li>Try out the Device Registrations & Listings API using the <Link to="/docs/device/registrionlisting/explore-the-api-with-an-interactive-chart/">interactive examples</Link>.</li>
        </ol>
