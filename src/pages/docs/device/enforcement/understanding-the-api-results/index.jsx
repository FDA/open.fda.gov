  ...
  render() {
    ...
    return (
      <section className="doc-content">
        ...
        <p>For count queries (such as: <a href="https://api.fda.gov/device/enforcement.json?count=voluntary_mandated.exact">https://api.fda.gov/device/enforcement.json?count=voluntary_mandated.exact</a>), the results section will look something like the following:</p>
        <Highlight
