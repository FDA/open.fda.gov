    ...
    return (
      <section className="doc-content">
        ...
        <ol>
          ...
          <li>Review the <Link to="/docs/drug/enforcement/searchable-fields">list of searchable fields</Link> available in the drug enforcement dataset.</li>
          <li>Try out the Drug Enforcement API using the <Link to="/docs/drug/enforcement/explore-the-api-with-an-interactive-chart/">interactive examples</Link> and tools below.</li>
        </ol>
