    ...
    return (
      <section className="doc-content">
        ...
        <ol>
          ...
          <li>Review the <Link to="/docs/drug/event/searchable-fields">list of searchable fields</Link> available in the drug adverse event dataset.</li>
          <li>Try out the Drug Adverse Event API using the <Link to="/docs/drug/event/explore-the-api-with-an-interactive-chart/">interactive examples</Link> and tools below.</li>
        </ol>
