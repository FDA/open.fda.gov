    ...
    return (
      <section className="doc-content">
        ...
        <ol>
          ...
          <li>Review the <Link to="/docs/drug/label/searchable-fields">list of searchable fields</Link> available in the drug labeling dataset.</li>
          <li>Try out the Drug Labeling API using the <Link to="/docs/drug/label/explore-the-api-with-an-interactive-chart/">interactive examples</Link> and tools below.</li>
        </ol>
