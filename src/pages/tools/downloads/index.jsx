...
import food_enforcement_meta from '../../docs/food/enforcement/_meta.yaml'
import food_event_meta from '../../docs/food/event/_meta.yaml'
import drug_enforcement_meta from '../../docs/drug/enforcement/_meta.yaml'
import drug_event_meta from '../../docs/drug/event/_meta.yaml'
import drug_label_meta from '../../docs/drug/label/_meta.yaml'
import device_510k_meta from '../../docs/device/510k/_meta.yaml'
import device_classification_meta from '../../docs/device/classification/_meta.yaml'
import device_enforcement_meta from '../../docs/device/classification/_meta.yaml'
import device_event_meta from '../../docs/device/event/_meta.yaml'
import device_pma_meta from '../../docs/device/pma/_meta.yaml'
import device_recall_meta from '../../docs/device/recall/_meta.yaml'
import device_registration_listing_meta from '../../docs/device/registrationlisting/_meta.yaml'
import device_udi_meta from '../../docs/device/udi/_meta.yaml'
