  ...
  render () {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Cosmetic Product Listing' endpoint_path='/apis/cosmetic/productlisting/'/>
        ...
        <p>In the example below, we are searching the records in the cosmetic product listing endpoint for matches with <code>fragrance_or_flavor</code> with the value <code>Fragrance</code>. We are requesting to see the first 5 records that match."</p>
        <APIQueryBreakdown endpoint_path='/cosmetic/productlisting.json' query='fragrance_or_flavor:"Fragrance"'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/cosmetic/productlisting.json</code></li>
