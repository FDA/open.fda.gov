  ...
  render() {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Device Adverse Event' endpoint_path='/apis/device/event/'/>
        ...
        <p>In the example below, we are searching the records in the Device Adverse Event endpoint for matches with <code>1</code> in the <code>patient.patient_sequence_number</code> field. We are requesting to see the first 5 records that match."</p>
        <APIQueryBreakdown endpoint_path='/device/event.json' query='device.generic_name:x-ray'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/device/event.json</code></li>
