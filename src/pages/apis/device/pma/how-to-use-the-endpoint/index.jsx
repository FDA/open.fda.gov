  ...
  render() {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Device Pre-Market Approval' endpoint_path='/apis/device/pma/'/>
        ...
        <p>In the example below, we are searching the records in the Device Pre-Market Approval endpoint for matches with <code>APPR</code> in the <code>decision_code</code> field. We are requesting to see the first 5 records that match."</p>
        <APIQueryBreakdown endpoint_path='/device/pma.json' query='decision_code:APPR'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/device/pma.json</code></li>
