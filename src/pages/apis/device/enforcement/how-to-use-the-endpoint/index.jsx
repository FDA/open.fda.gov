  ...
  render() {
    ...
    return (
      <section className="doc-content">
        ...
        <APIUseSteps endpoint_name='Device Enforcement' endpoint_path='/apis/device/enforcement/'/>
        ...
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/device/enforcement.json</code></li>
