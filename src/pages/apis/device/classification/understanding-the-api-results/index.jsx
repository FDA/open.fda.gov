  ...
  render() {
    ...
    return (
      <section className="doc-content">
        ...
        <p>For <code>count</code> queries (such as: <a href="https://api.fda.gov/device/classification.json?count=openfda.fei_number">https://api.fda.gov/device/510k.json?count=openfda.fei_number</a>), the results section will look something like the following:</p>
        <Highlight
