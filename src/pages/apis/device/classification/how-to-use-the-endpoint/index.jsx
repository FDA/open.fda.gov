  ...
  render() {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Device Classification' endpoint_path='/apis/device/classification/'/>
        ...
        <p>In the example below, we are searching the records in the Device Classification endpoint for matches with <code>NOB</code> in the <code>product_code</code> field. We are requesting to see the first 5 records that match."</p>
        <APIQueryBreakdown endpoint_path='/device/classification.json' query='product_code:NOB'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/device/classification.json</code></li>
