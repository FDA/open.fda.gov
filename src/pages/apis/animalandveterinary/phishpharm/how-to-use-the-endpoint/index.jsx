  ...
  render() {
    ...
    return (
      <section className="doc-content">
        ...
        <APIUseSteps endpoint_name='Phish-Pharm' endpoint_path='/apis/animalandveterinary/phishpharm/'/>
        ...
        <p>In the example below, we are searching the records in the Phish-Pharm endpoint for matches with <code>freshwater</code> in the <code>water_type</code> field. We are requesting to see the first 5 records that match."</p>
        <APIQueryBreakdown endpoint_path='/animalandveterinary/phishpharm.json' query='water_type:freshwater'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/animalandveterinary/phishpharm.json</code></li>
