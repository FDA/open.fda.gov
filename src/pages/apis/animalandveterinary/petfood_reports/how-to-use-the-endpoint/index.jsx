  ...
  render() {
    ...
    return (
      <section className="doc-content">
        ...
        <APIUseSteps endpoint_name='Animal & Veterinary Pet Food' endpoint_path='/apis/animalandveterinary/petfood/'/>
        ...
        <p>In the example below, we are searching the records in the animal & veterinary pet food endpoint for matches with <code>Dry</code> in the <code>product.formulation</code> field. We are requesting to see the first 5 records that match."</p>
        <APIQueryBreakdown endpoint_path='/animalandveterinary/petfood_reports.json' query='product.formulation:Dry'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/animalandveterinary/petfood_reports.json</code></li>
