  ...
  render() {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Tobacco Products List' endpoint_path='/apis/tobacco/products/'/>
        ...
        <p>In the example below, we are searching the records in the tobacco products endpoint for matches with <code>Strawberry</code> in the <code>product_name</code> field. We are requesting to see the first 5 records that match.</p>
        <APIQueryBreakdown endpoint_path='/tobacco/products.json' query='product_name:"Strawberry"'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/tobacco/products.json</code></li>
