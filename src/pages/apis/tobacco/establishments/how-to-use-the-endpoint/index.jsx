  ...
  render() {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Tobacco Establishment Registrations' endpoint_path='/apis/tobacco/establishments/'/>
        ...
        <p>In the example below, we are searching the records in the tobacco establishment registrations endpoint for matches with <code>BLENDING</code> in the <code>operation_type</code> field. We are requesting to see the first 5 records that match.</p>
        <APIQueryBreakdown endpoint_path='/tobacco/establishments.json' query='operation_type:"BLENDING"'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/tobacco/establishments.json</code></li>
