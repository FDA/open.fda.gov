  ...
  render () {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Tobacco Prevention Ads Research' endpoint_path='/apis/tobacco/researchpreventionads/'/>
        ...
        <p>In the example below, we are searching the records in the tobacco prevention ads research endpoint for matches with <code>ad_number</code> with the value <code>Ad 1</code>. We are requesting to see the first 5 records that match."</p>
        <APIQueryBreakdown endpoint_path='/tobacco/researchpreventionads.json' query='ad_number:"Ad 1"'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://openfda-api.preprod.fda.gov/tobacco/researchpreventionads.json</code></li>
