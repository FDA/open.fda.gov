  ...
  render() {
    ...
    return (
      <section className="doc-content">
        ...
        <APIUseSteps endpoint_name='Tobacco Adverse Events' endpoint_path='/apis/tobacco/event/'/>
        ...
        <p>In the example below, we are searching the records in the tobacco adverse events endpoint for matches with <code>report_id</code> with the value <code>2082161</code>. We are requesting to see the first 5 records that match."</p>
        <APIQueryBreakdown endpoint_path='/tobacco/event.json' query='report_id:2082161'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://openfda-api.preprod.fda.gov/tobacco/event.json</code></li>
