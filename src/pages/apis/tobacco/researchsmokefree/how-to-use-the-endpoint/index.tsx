  ...
  render () {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Tobacco Smokefree Research' endpoint_path='/apis/tobacco/researchsmokefree/'/>
        ...
        <p>In the example below, we are searching the records in the tobacco smokefree research endpoint for matches with <code>variable</code> with the value <code>How to Quit Vaping Page</code>. We are requesting to see the first 5 records that match."</p>
        <APIQueryBreakdown endpoint_path='/tobacco/researchsmokefree.json' query='variable:"How to Quit Vaping Page"'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/tobacco/researchsmokefree.json</code></li>
