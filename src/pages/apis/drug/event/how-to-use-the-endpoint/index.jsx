  ...
  render() {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Drug Adverse Event' endpoint_path='/apis/drug/event/'/>
        ...
        <p>In the example below, we are searching the records in the drug adverse events endpoint for matches with <code>headache</code> in the <code>reactionmeddrapt</code> field. We are requesting to see the first 5 records that match."</p>
        <APIQueryBreakdown endpoint_path='/drug/event.json' query='reactionmeddrapt:"headache"'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/drug/event.json</code></li>
