  ...
  render() {
    ...
    return (
      <section className="doc-content">
        ...
        <APIUseSteps endpoint_name='Drug Labeling' endpoint_path='/apis/drug/label/'/>
        ...
        <p>In the example below, we are searching the records in the drug labeling endpoint for matches with <code>headache</code> in the <code>reactionmeddrapt</code> field. We are requesting to see the first 5 records that match."</p>
        <APIQueryBreakdown endpoint_path='/drug/label.json' query='drug_interactions:caffeine'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/drug/label.json</code></li>
