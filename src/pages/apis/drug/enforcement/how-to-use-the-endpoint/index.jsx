  ...
  render() {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Drug Enforcement' endpoint_path='/apis/drug/enforcement/'/>
        ...
        <APIQueryBreakdown endpoint_path='/drug/enforcement.json' query='classification:"Class III"'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/drug/enforcement.json</code></li>
