  ...
  render() {
    ...
    return (
      <section className="doc-content">
        ...
        <p>For <code>search</code> queries (such as: <a href="https://api.fda.gov/drug/orangebook.json?limit=1">https://api.fda.gov/drug/orangebook.json?limit=1</a>), the <code>results</code> section includes matching ndc results returned by the API.</p>
        ...
        <p>For <code>count</code> queries (such as: <a href="https://api.fda.gov/drug/orangebook.json?count=dea_schedule">https://api.fda.gov/drug/orangebook.json?count=dea_schedule</a>), the results section will look something like the following:</p>
        <Highlight
