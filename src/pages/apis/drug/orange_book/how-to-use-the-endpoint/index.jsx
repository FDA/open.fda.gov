  ...
  render() {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Drug Orange Book' endpoint_path='/apis/drug/orangebook/'/>
        ...
        <p>In the example below, we are searching the records in the orange book endpoint for matches with <code>Class III</code> in the <code>classification</code> field. We are requesting to see the first 5 records that match."</p>
        <APIQueryBreakdown endpoint_path='/drug/orangebook.json' query='dea_schedule:"CIV"'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/drug/orangebook.json</code></li>
