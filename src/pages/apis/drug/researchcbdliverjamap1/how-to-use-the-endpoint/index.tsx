  ...
  render () {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='CBD Liver JAMA Research Part One' endpoint_path='/apis/drug/researchcbdliverjamap1/'/>
        ...
        <p>In the example below, we are searching the records in the CBD Liver JAMA Research Part One endpoint for matches with <code>Placebo</code> in the <code>treatment</code> field. We are requesting to see the first 5 records that match.</p>
        <APIQueryBreakdown endpoint_path='/drug/researchcbdliverjamap1.json' query='treatment:"Placebo"'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/drug/researchcbdliverjamap1.json</code></li>
