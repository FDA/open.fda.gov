  ...
  render () {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Opioid and SSRI Interactions Research' endpoint_path='/apis/drug/researchopioidandssri/'/>
        ...
        <p>In the example below, we are searching the records in the Drug Opioid and SSRI Interactions Research endpoint for matches with <code>AP</code> in the <code>Placebo</code> field. We are requesting to see the first 5 records that match.</p>
        <APIQueryBreakdown endpoint_path='/drug/researchopioidandssri.json' query='drug:"Placebo"'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/drug/researchopioidandssri.json</code></li>
