  ...
  render () {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Tobacco Prevention Ads Research' endpoint_path='/apis/research/tobaccopreventionads/'/>
        ...
        <APIQueryBreakdown endpoint_path='/research/tobaccopreventionads.json' query='ad_number:"Ad 1"'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/research/tobaccopreventionads.json</code></li>
