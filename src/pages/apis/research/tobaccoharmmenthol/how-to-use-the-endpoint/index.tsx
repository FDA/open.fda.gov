  ...
  render () {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Tobacco Harm Menthol Research' endpoint_path='/apis/research/tobaccoharmmenthol/'/>
        ...
        <p>In the example below, we are searching the records in the tobacco harm menthol research endpoint for matches with <code>tobacco_ad_exposure.retail</code> with the value <code>Yes</code>. We are requesting to see the first 5 records that match."</p>
        <APIQueryBreakdown endpoint_path='/research/tobaccoharmmenthol.json' query='tobacco_ad_exposure.retail:Yes'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/research/tobaccoharmmenthol.json</code></li>
