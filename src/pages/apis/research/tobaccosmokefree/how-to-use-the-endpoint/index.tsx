  ...
  render () {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Tobacco Smokefree Research' endpoint_path='/apis/research/tobaccosmokefree/'/>
        ...
        <APIQueryBreakdown endpoint_path='/research/tobaccosmokefree.json' query='variable:"How to Quit Vaping Page"'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/research/tobaccosmokefree.json</code></li>
