  ...
  render () {
    ...
    return (
      <section className='doc-content'>
        ...
        <p>This dataset makes available the research paper "Integrated miR-omics and Proteomics Reveal the Regulatory Role of miR in Protein Networks Associated with COVID-19 Disease Progression"</p>
