  ...
  render () {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Covid miRNA and Proteomics Research' endpoint_path='/apis/research/covidmirnaandproteomics/'/>
        ...
        <p>In the example below, we are searching the records in the Covid miRNA and Proteomics Research endpoint for matches with <code>qc_control</code> with the value <code>Pooled Sample</code>. We are requesting to see the first 5 records that match."</p>
        <APIQueryBreakdown endpoint_path='/research/covidmirnaandproteomics.json' query='qc_control:"Pooled Sample"'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/research/covidmirnaandproteomics.json</code></li>
