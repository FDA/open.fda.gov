  ...
  render() {
    return (
      <section className="doc-content">
        ...
        <p>OpenFDA is an <a href="http://www.elasticsearch.org/">Elasticsearch-based</a> <a href="http://apievangelist.com/index.html">API</a> that serves public <a href="http://www.fda.gov/">FDA</a> data about nouns like <Link to="/apis/drug/">drugs</Link>, <Link to="/apis/device/">devices</Link>, and <Link to="/apis/food/">foods</Link>.</p>
