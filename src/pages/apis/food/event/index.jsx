...
class IndexRoute extends React.Component {
  render() {
    ...
    <h3>Disclaimer</h3>
    <p>CAERS data does have limitations. There is no certainty that the reported event (adverse event) was actually due to the product. FDA does not require that a causal relationship between a product and event be proven, and reports do not always contain enough detail to properly evaluate an event.</p>
