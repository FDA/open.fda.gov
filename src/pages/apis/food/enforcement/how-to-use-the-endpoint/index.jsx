  ...
  render() {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Food Enforcement' endpoint_path='/apis/food/enforcement/'/>
        ...
        <APIQueryBreakdown endpoint_path='/food/enforcement.json' query='distribution_pattern:"nationwide"'/>
