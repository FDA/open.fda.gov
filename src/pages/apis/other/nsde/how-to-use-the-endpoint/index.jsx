  ...
  render() {
    ...
    return (
      <section className='doc-content'>
        ...
        <p>In the example below, we are searching the records in the drug adverse events endpoint for matches which have a <code>marketing_end_date</code>. We are requesting to see the first 5 records that match.</p>
        <APIQueryBreakdown endpoint_path='/other/nsde.json' query='_exists_:"marketing_end_date"'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/other/nsde.json</code></li>
