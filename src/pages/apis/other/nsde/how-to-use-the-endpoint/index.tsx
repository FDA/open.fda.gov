  ...
  render () {
    ...
    return (
      <section className='doc-content'>
        ...
        <p>In the example below, we are searching the records in the nsde endpoint for matches which have a <code>marketing_end_date</code>. We are requesting to see the first 5 records that match.</p>
