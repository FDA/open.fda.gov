  ...
  render () {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Approved CRLs' endpoint_path='/apis/other/crl/'/>
        ...
        <APIQueryBreakdown endpoint_path='/other/crl.json' query='approver_title:Acting Deputy Director'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/other/crl.json</code></li>
