  ...
  render () {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Other PubMed' endpoint_path='/apis/other/pubmed/'/>
        ...
        <p>In the example below, we are searching the records in the PubMed endpoint for matches which have a <code>ppmid</code>. We are requesting to see the first 5 records that match.</p>
        <APIQueryBreakdown endpoint_path='/other/pubmed.json' query='_exists_:"pmid"'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/other/pubmed.json</code></li>
