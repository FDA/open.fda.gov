  ...
  render () {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Peer Reviewed Journals' endpoint_path='/apis/publications/peerreviewed/'/>
        ...
        <p>In the example below, we are searching for FDA <i>letters</i>.</p>
        <APIQueryBreakdown endpoint_path='/publications/peerreviewed.json' query='journal_type:Letter'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA API query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/publications/peerreviewed.json</code></li>
